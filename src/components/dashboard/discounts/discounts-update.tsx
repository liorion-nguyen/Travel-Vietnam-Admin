...
export function UpdateDiscount(props: DiscountUpdateProps): React.ReactElement {
  ...
  const formik = useFormik<CreateDiscountRequestDto>({
    ...
    onSubmit: async () => {
      // TODO: Implement update discount
    },
  });

  const handleSubmit = async (): Promise<void> => {
    await discountApi.updateDiscount(formik.values, discountId);
    formik.resetForm();
    onClose();
  };
